...
export const usuariosOrganizacion = [
  {
    ...
    area: "Capítulo de Ingeniería Civil",
    sede: "Cusco",
    rol: "Estudiante",
    progreso: 82,
    estado: "ACTIVO",
  ...
  },
  {
    ...
    area: "Capítulo de Ingeniería Industrial",
    sede: "Cusco",
    rol: "Estudiante",
    progreso: 64,
    estado: "ACTIVO",
    ...
    colegiaturaActiva: true,
    unidadPrincipalId: "unidad-capitulo-industrial",
    sedeId: "sede-cusco",
  },
  {
    id: 3,
    ...
    especialidad: "Ingeniería Civil",
    colegiaturaActiva: true,
    unidadPrincipalId: "unidad-direccion-gobierno",
    sedeId: "sede-lima",
  },
  {
    id: 4,
    ...
    area: "Pendiente de incorporación",
    sede: "Cusco",
    rol: "Estudiante",
    progreso: 28,
    estado: "INVITADO",
  ...
  },
  {
    ...
    area: "Comisión de Certificación",
    sede: "Lima",
    rol: "Estudiante",
    progreso: 76,
    estado: "ACTIVO",
    especialidad: "Ingeniería Civil",
    colegiaturaActiva: true,
    unidadPrincipalId: "unidad-comision-certificacion",
    sedeId: "sede-lima",
  },
  {
    id: 6,
  ...
  },
  {
    ...
    area: "Capítulo de Ingeniería de Sistemas",
    sede: "Lima",
    rol: "Estudiante",
    progreso: 58,
    estado: "ACTIVO",
    ...
    colegiaturaActiva: true,
    unidadPrincipalId: "unidad-capitulo-sistemas",
    sedeId: "sede-lima",
  },
  {
    id: 8,
  ...
  },
  {
    ...
    especialidad: "Ingeniería Industrial",
    colegiaturaActiva: true,
    unidadPrincipalId: "unidad-administracion",
    sedeId: "sede-lima",
  },
  {
    id: 10,
  ...
  },
  {
    ...
    especialidad: "Ingeniería Civil",
    colegiaturaActiva: true,
    unidadPrincipalId: "unidad-comite-estructuras",
    sedeId: "sede-cusco",
  },
  {
    id: 12,
...
export const areasOrganizacion = [
  {
    id: "unidad-capitulo-civil",
    nombre: "Capítulo de Ingeniería Civil",
    usuarios: 4,
    responsable: "Carlos Mendoza Ruiz",
    progreso: 76,
    color: "bg-blue-600",
  },
  {
    id: "unidad-capitulo-industrial",
    nombre: "Capítulo de Ingeniería Industrial",
    usuarios: 2,
    responsable: "Luis Alberto Rojas",
    progreso: 68,
    color: "bg-teal-600",
  },
  {
    id: "unidad-capitulo-sistemas",
    nombre: "Capítulo de Ingeniería de Sistemas",
    usuarios: 1,
    responsable: "Elena Salazar Medina",
    progreso: 84,
    color: "bg-violet-600",
  },
  {
    ...
    usuarios: 2,
    responsable: "Rosa Mendoza Quispe",
    progreso: 61,
    color: "bg-amber-500",
  },
];
...
export const alertasOrganizacion = [
  ...
  },
  {
    ...
    detalle:
      "Administración registra 61% de avance, por debajo del promedio institucional.",
  ...
  },
  {
    ...
    detalle:
      "Tukuy Almacén en el Capítulo de Ingeniería Industrial alcanzó 29% de finalización.",
    prioridad: "alta" as const,
  },
  {
    id: 5,
...
export const actividadOrganizacion = [
  {
    ...
    detalle: "Control de almacén y Kardex asignado al Capítulo de Ingeniería Industrial.",
    tiempo: "Hace 2 h",
  },
  {
  ...
  },
  {
    ...
    detalle: "4 nuevos accesos enviados al Capítulo de Ingeniería Civil.",
    tiempo: "Hace 3 días",
  },
  {
  ...
  },
  {
    ...
    detalle: "Administración superó 84% de avance promedio.",
    tiempo: "Hace 2 días",
  },
];
...
export const catalogoCursosOrganizacion: PropuestaCursoOrganizacionMock[] = [
  ...
  },
  {
    ...
    gratuito: false,
    alcance: "AREA",
    destinoArea: "Administración",
    descuentoInterno: 25,
    descuentoAplicaA: "AREA",
    descuentoArea: "Administración",
  },
  {
    id: "prop-doc-1",
