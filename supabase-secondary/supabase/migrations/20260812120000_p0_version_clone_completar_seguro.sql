-- P0 LMS: no mover actividades entre versiones + completar confiable por tipo.
-- Ejecutar en el SQL Editor del proyecto SECUNDARIO (después de 12100000 y 12110000).
...
begin
  ...
  -- Actividad debe pertenecer a la versión de la matrícula.
  ...
  -- Quiz: solo completar si la nota de este intento (o la mejor) aprueba.
  ...
  -- Assignment: solo completar si hay entrega registrada.
