-- Fix cast modalidad/estado con search_path vacío (modalidad_formacion).
-- Ejecutar en SQL Editor SECUNDARIO. Requiere _servicio_sql_tipo_cast (20260805252200).
-- Mantiene la lógica de 20260812160000 (IDs estables / soft-delete).
begin;
